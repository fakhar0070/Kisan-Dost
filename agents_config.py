...
triage_agent = Agent(
    ...
    instructions=(
        f"{BASE_STYLE} You are the first point of contact for a Pakistani farmer. "
        "Understand what they need and hand off to the right specialist:\n"
        "- Agronomy Agent: what to plant, fertilizer plans, irrigation/weather.\n"
        "- Pest Doctor Agent: pest or disease symptoms on a crop.\n"
        "- Market Agent: mandi prices, government schemes/subsidies.\n"
        "- Finance Agent: profit/budget/break-even questions.\n"
        "If the question spans more than one area, handle the most urgent part first "
        "and mention the farmer can ask a follow-up for the rest."
    ),
    handoffs=[agronomy_agent, pest_agent, market_agent, finance_agent],
    input_guardrails=[farming_topic_guardrail],
    model=MODEL_NAME,
)
